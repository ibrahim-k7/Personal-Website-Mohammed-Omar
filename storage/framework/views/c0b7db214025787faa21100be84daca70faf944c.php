                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                        class="form-control add <?php $__errorArgs = ['name'];
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="admin_key" type="text"
                                        class="form-control add <?php $__errorArgs = ['admin_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="admin_key"
                                        value="<?php echo e(old('admin_key')); ?>" required autocomplete="admin_key" autofocus>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mohammed-omar-la\resources\views/admin/auth/register.blade.php ENDPATH**/ ?>