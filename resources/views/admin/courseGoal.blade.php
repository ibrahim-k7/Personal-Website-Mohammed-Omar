            ...
            @foreach ($course_data as $info)
                <div class="col-lg-6 col-sm-12 mt-3 mb-3">
                    <div class=" card index">
                        <div class="card-header text-center m-3" style="background-color: #C8C1CD;  border: 1px solid black ; border-radius: 10px;">{{ $info->goal}} </div>

                        <div class="card-body text-center">
                            <div class="row">
                                <div class="col-6"> <a href="{{ route('edit.Goal',$info->id) }}" class="btn px-3"
                                        style="background-color: #6c4996c0;  border: 1px solid black ; border-radius: 10px;">تحديث</a>
                                </div>
                                <div class="col-6">
                                    <a href="{{ route('destroy.Goal', $info->id) }}" class="btn px-3"
